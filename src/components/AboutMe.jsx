  ...
  return (
    <section id="about-me" className="bg-gray-100 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 id="about-me-heading" className="text-4xl font-semibold text-gray-800 text-center mb-8">
          About Me
        </h2>
        <div id="about-me-text" className="grid grid-cols-1">
          {/* About Me Text */}
          <div>
            <p id="about-me-introduction" className="text-lg text-gray-600 mb-6">
            ...
            <p id="about-me-developer" className="text-lg text-gray-600 mb-6">
            ...
            <p id="about-me-hobbies" className="text-lg text-gray-600">
